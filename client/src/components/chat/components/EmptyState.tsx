...
function EmptyState( {onToggleSidebar,onQueryChange}:TEmpty) {
  return (
    <div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-8">
        {/**
             ...
             */}
        <div className="w-full max-w-2xl rounded-4xl border border-dashed border-zinc-200 bg-white/90 p-10 text-center shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/90">
